...
if command -v eza &>/dev/null; then
    ...
    alias lw='ls -xAh  --color=always'    # wide format
    alias labc='ls -lap --color=always'   # alphabetical
...
alias vs='nvim -S'    # restore session
...
#--- Git (gb avoided — conflicts with AMD gbuild wrapper) -----
alias g='git'
...
#--- tldr / cheat fallback ------------------------------------
if ! command -v tldr &>/dev/null && command -v cheat &>/dev/null; then
    alias tldr='cheat'
fi
